...
\begin{exercicio}
  ...
  \begin{enumerate}[label={\alph*)}]
    ...
    \item $V$ é o conjunto de todas as matrizes $2 \times 2$ invertíveis com as operações usuais de adição e multiplicação por escalar.
    ...
    \item O conjunto
      \[
         V = \left\{\begin{bmatrix}x\\y \end{bmatrix} \mid x, y \in \real\right\}
      \]
      com as operações usuais de adição e multiplicação por escalar.
    ...
    \item O conjunto
      ...
      \]
      com as operações usual de adição e multiplicação por escalar definida por
      \[
    ...
    \item O conjunto
      ...
      \]
      com a operações usual multiplicação por escalar e a adição definida por
      \[
    ...
    \item O conjunto
      ...
      \]
      com a operações usuais de adição e multiplicação por escalar.

    \item O conjunto
      \[
         V = \left\{\begin{bmatrix}x\\y \end{bmatrix} \mid x, y \in \complex\right\}
      \]
      com a operações usuais de adição e multiplicação por escalar definida por
      \[
