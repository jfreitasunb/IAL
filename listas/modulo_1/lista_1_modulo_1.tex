...
\begin{exercicio}
  ...
  \begin{solucao}
    \begin{enumerate}[label={\alph*})]
        ...
        \item $3(A - \dfrac{1}{2}B) = \begin{pmatrix} 4 & 6 & 17/2\\9/2 & 3 & -7/2\end{pmatrix}$
...
\begin{exercicio}
    ...
    \begin{solucao}
        \begin{enumerate}[label={\alph*})]
            \item $3A + 4B = \begin{pmatrix}5 & -15\\18 & \phantom{-} 5\end{pmatrix}$
            ...
            \item $7A + 5B = \begin{pmatrix}44 & -22 & -20\\53 & \phantom{-}10 &\phantom{-}26\\35 &\phantom{-}21 & \phantom{-}94\end{pmatrix}$
        \end{enumerate}
    \end{solucao}
\end{exercicio}
...
\begin{exercicio}
    ...
    \begin{solucao}
        \begin{enumerate}
            \item $a = 4$, $b = -6$, $c = -1$, $d = 1$
            \item $a = 9/2$, $b = -7/2$, $c = -4/5$, $d = 13/5$
        \end{enumerate}
    \end{solucao}
\end{exercicio}
...
\begin{exercicio}
    ...
    \begin{align*}
        ...
        E = (e_{ij})_{5 \times 4}.
    \end{align*}
    Determine quais das operações a seguir estão definidas. Para aquelas que estiverem definidas, determine a ordem da matriz resultante.
    Quando não estiver definida, explique por que não está definida.
    \begin{multicols}{2}
        \begin{enumerate}[label={\alph*})]
            \item $AB$
