...
\noindent {\bf{SISTEMA DE AVALIA\c{C}\~{A}O:}} em cada um dos módulos sera realizada uma prova e  atribuídauma nota $M_i$, $i=1$, 2, 3. A nota final ($NF$) de cada estudante ser\'a dada por:
\[
