...
\begin{document}
    ...
    \begin{frame}
        \begin{definicao}
	    Se $A$ e $B$ s\~ao matrizes $m \times n$, \pause dizemos que $B$ \'e \textbf{linha-equivalente} \pause a $A$, \pause se $B$ for obtida de $A$ \pause atrav\'es de uma quantidade finita de opera\c{c}\~oes elementares sobre as linhas de $A$.\pause
        \end{definicao}
