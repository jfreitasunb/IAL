...
\begin{document}
    ...
    \begin{definicao}
        ...
        \begin{enumerate}[label={\roman*})]
            \item Um \textbf{autovalor} \pause de $T$ é um elemento $\lambda \in \cp{K}$ \pause tal que existe um vetor não nulo \pause $u \in V$ \pause com $T(u) = \lambda u$.\pause \index{Autovalor}
