...
\begin{frame}
    Considere um espaço vetorial $V$ \pause sobre um corpo $\cp{K}$ \pause de dimensão $n$. \pause Tomando duas bases para esse espaço, \pause digamos, $\mathcal{B} = \{u_1, u_2, \dots, u_n\}$ \pause e $\mathcal{C} = \{w_1, w_2, \dots, w_n\}$ \pause é possível relacionar as matrizes\pause
    \begin{align*}
