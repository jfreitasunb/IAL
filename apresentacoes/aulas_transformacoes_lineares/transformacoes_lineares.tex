...
\begin{frame}
    \begin{proposicao}\label{caracteriza_transformacao_injetora}
        Sejam $V$ e $W$ $\cp{K}$-espa\c{c}os vetoriais \pause e $T \colon V \to W$ uma transforma\c{c}\~ao linear. \pause Ent\~ao $T$ \'e injetora \pause se, e somente se, $\ker T = \{0_V\}$.
    \end{proposicao}
\end{frame}

\begin{frame}
    \begin{teorema}[Teorema do N\'ucleo e da Imagem]\label{teorema_do_nucleo_e_da_imagem}
        Sejam $V$ e $W$ $\cp{K}$-espa\c{c}os vetoriais \pause com $\dim_\cp{K}V$ finita. \pause Seja $T : V \to W$ uma transforma\c{c}\~ao linear. \pause Ent\~ao
        \[
