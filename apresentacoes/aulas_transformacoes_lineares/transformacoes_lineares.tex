...
%    \end{frame}
    ...
    \begin{frame}
        \begin{teorema}
            Sejam $V$ um $\cp{K}$-espaço vetorial de dimensão $n \ge 1$, \pause $\mathcal{B}_1 = \{u_1, u_2, \dots, u_n\}$ e $\mathcal{B}_2 = \{w_1, w_2, \dots, w_n\}$ bases ordenadas de $V$.
    ...
    \begin{frame}
        \begin{definicao}
            ...
            denotada por $P = [I]_{{\mathcal{B}_1},{\mathcal{B}_2}}$ ou por $P_{\mathcal{B}_1 \to \mathcal{B}_2}$.
        \end{definicao}
    \end{frame}
