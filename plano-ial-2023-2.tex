...
\noindent {\bf{SISTEMA DE AVALIA\c{C}\~{A}O:}} em cada um dos módulos o aluno receberá uma nota $M_i$, $i=1$, 2, 3, dada por
\[
...
A partir das notas dos módulos, a nota final ($NF$) de cada estudante ser\'a dada por:
\[
